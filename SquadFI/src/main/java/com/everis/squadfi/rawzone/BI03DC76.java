...
public class BI03DC76 {

	public BI03DC76() {
		log.info("\n [ Iniciando JOB - BI03DC78 ]\n");
		Class<BI03DC76> bi03dc78 = BI03DC76.class;
		RawConfig r = new RawConfig(bi03dc78);
		r.submit(r.getOption(bi03dc78));
	}

	private static final Logger log = Logger.getLogger(BI03DC76.class);
	...
	public static void main(String[] args) {
		for (Field f : BI03DC76.class.getDeclaredFields()) {
