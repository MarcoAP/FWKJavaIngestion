...
public class BI03DC77 {

	public BI03DC77() {
		log.info("\n [ Iniciando JOB - BI03DC78 ]\n");
		Class<BI03DC77> bi03dc78 = BI03DC77.class;
		RawConfig r = new RawConfig(bi03dc78);
		r.submit(r.getOption(bi03dc78));
	}

	private static final Logger log = Logger.getLogger(BI03DC77.class);
	...
	public static void main(String[] args) {
		for (Field f : BI03DC77.class.getDeclaredFields()) {
