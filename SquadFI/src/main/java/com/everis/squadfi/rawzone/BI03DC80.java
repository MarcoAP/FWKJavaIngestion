...
public class BI03DC80 {

	public BI03DC80() {
		log.info("\n [ Iniciando JOB - BI03DC78 ]\n");
		Class<BI03DC80> bi03dc78 = BI03DC80.class;
		RawConfig r = new RawConfig(bi03dc78);
		r.submit(r.getOption(bi03dc78));
	}

	private static final Logger log = Logger.getLogger(BI03DC80.class);
	...
	public static void main(String[] args) {
		for (Field f : BI03DC80.class.getDeclaredFields()) {
